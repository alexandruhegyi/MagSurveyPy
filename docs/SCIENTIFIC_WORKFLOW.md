...
MagSurveyPy 1.0.2 uses a workflow that keeps original/reference data separate from derived products in which every command group has a defined scientific role.
